const translations = {
  en: {
    ...
    footerAddressText: "847/10 Deep Street, Ekecs Slovakia 93028",
    ...
    visitHeading: "Visit Our Local Florist Store in Ekecs",
    visitParagraph:
    ...
    aboutHeading: "About Andrea Flowers Shop Slovakia",
    aboutParagraph:
      "Recognised as one of the best florists near Dunajská Streda, Andrea Flowers combines passion and expertise to bring elegance to every floral design. Our commitment to quality and customer satisfaction has made us a beloved Andrea Flowers shop in Slovakia. Learn more about our story and why locals trust us for all their floral needs.",
    historyHeading: "History of the shop",
    historyParagraph:
    ...
    visitTeamHeading: "Visit Our Store and Meet the Team",
    visitTeamParagraph1:
  ...
  hu: {
    ...
    heroHeading: "Helyi virágkötője Ekecsen – Friss virágok minden alkalomra",
    heroText:
    ...
    visitHeading: "Látogasson el helyi virágüzletünkbe Ekecsen!",
    visitParagraph:
    ...
    visitTeamHeading: "Látogasson el üzletünkbe és ismerje meg csapatunkat",
    visitTeamParagraph1:
